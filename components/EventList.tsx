  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex items-center justify-between mb-8">
            <div>
                <h1 className="text-3xl font-bold text-ray-900">Upcoming Events</h1>
                <p className="mt-2 text-gray-600">Discover exciting events and secure your tickets</p>
            </div>
            <div className="bg-white px-4 py-2 rounded-;g shadow-sm border border-gray-100">
